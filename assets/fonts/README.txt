...
This means all the styles are contained in these files:
  PlusJakartaSans-VariableFont-wght.ttf
  PlusJakartaSans-Italic-VariableFont-wght.ttf
...
In desktop apps
  ...
  https://helpx.adobe.com/nz/photoshop/using/fonts.html#variable-fonts

Online

  https://developers.google.com/fonts/docs/getting-started
  https://developer.mozilla.org/en-US/docs/Web/CSS/CSS-Fonts/Variable-Fonts-Guide
